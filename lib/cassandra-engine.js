  ...
  getConnectionSettings() {
    return new ConnectionSettings({
      ...
      custom: [
        ...
        new FieldConnection({id: 'datacenter', title: "Data Center"}),
        new FieldConnection({id: 'keyspace', title: "Keyspace"}),
  ...
  _connect(connectionFields) {
    return new Promise((resolve) => {
      resolve(new cassandra.Client({
        ...
        // port: ccf.port,
        // credentials: {username:ccf.user, password:ccf.password},
...
//       resolve(mariadb.createPool(config));
  ...
  resolveDoubleClick(connectionName, datasets, onDone) {
    console.log("resolveDoubleClick")
